...
def get_num_class(hparams):
    ...
    if 'casia-webface converted' in hparams.train_data_path.lower():
        # Custom CASIA-WebFace
        assert not hparams.train_data_subset
        class_num = 10572  # Adjust this number to match your actual number of classes
    elif 'faces_emore' in hparams.train_data_path.lower():
        # MS1MV2
