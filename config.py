...
def get_args():
    parser = argparse.ArgumentParser(description='Train face recognition with AdaFace')
    ...
    # QAConv parameters
    parent_parser.add_argument('--k_nearest', default=32, type=int,
                        help='Number of nearest classes to consider in QAConv (default: 32)')
